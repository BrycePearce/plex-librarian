...
function SettingsPage() {
  ...
  const { data: latestSuccessfulSync, isPending: latestSuccessPending } = useQuery({
            ...
            {data
              ? (
                <DebouncedDaysInput
                  ...
                  mutationFn={(value) => api.settings.update({ staleMinAgeDays: value })}
            ...
            {data
              ? (
                <DebouncedDaysInput
                  ...
                  mutationFn={(value) => api.settings.update({ inactiveUserDays: value })}
            ...
            {data
              ? (
                <DebouncedDaysInput
                  ...
                  mutationFn={(value) => api.settings.update({ ipHistoryRetentionDays: value })}
            ...
            {data
              ? (
                <DebouncedDaysInput
                  ...
                  mutationFn={(value) => api.settings.update({ pendingInviteStaleDays: value })}
            ...
            {data
              ? (
                <DebouncedDaysInput
                  ...
                  mutationFn={(value) => api.settings.update({ pendingInviteCriticalDays: value })}
