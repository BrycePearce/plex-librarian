...
export const itemMediaVersions = sqliteTable(
  'item_media_versions',
  {
    ...
    videoDynamicRange: text('video_dynamic_range'),
    videoFrameRate: text('video_frame_rate'),
    videoScanType: text('video_scan_type'),
    container: text('container'),
    audioCodec: text('audio_codec'),
    audioChannels: integer('audio_channels'),
    audioProfile: text('audio_profile'),
    audioStreamsJson: text('audio_streams_json'),
    subtitleStreamsJson: text('subtitle_streams_json'),
    streamDetailsAvailable: integer('stream_details_available', { mode: 'boolean' })
...
export const deletionOperations = sqliteTable(
  'deletion_operations',
  {
    ...
    removalConfirmedCount: integer('removal_confirmed_count').notNull().default(0),
...
export const deletionTargets = sqliteTable(
  'deletion_targets',
  {
    ...
    removalConfirmedAt: integer('removal_confirmed_at'),
    plexReconciledAt: integer('plex_reconciled_at'),
    plexAttemptCount: integer('plex_attempt_count').notNull().default(0),
