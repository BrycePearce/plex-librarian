      ...
      await db
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            audioStreamsJson: excl(itemMediaVersions.audioStreamsJson),
            subtitleStreamsJson: excl(itemMediaVersions.subtitleStreamsJson),
            streamDetailsAvailable: excl(itemMediaVersions.streamDetailsAvailable),
